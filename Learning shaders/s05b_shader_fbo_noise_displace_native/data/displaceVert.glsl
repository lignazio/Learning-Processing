...
void main() {
  ...
  float valuex = fbm(vec3(vertTexCoord.st+0,time/10.0));
  float valuey = fbm(vec3(vertTexCoord.st+100.0,time/10.0));
  float valuez = fbm(vec3(vertTexCoord.st+200.0,time/10.0));
